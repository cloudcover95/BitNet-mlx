...
"""
QAT-ready Hybrid Ternary Mapping with Straight-Through Estimator (STE).
Routes gradients through non-differentiable discrete boundaries.
"""
...
"""Bidirectional execution layer for QAT and stateless inference."""
def init(self, in_d: int, out_d: int, bias: bool = False, activation_bits: int = 8):
super().init()
self.bits = activation_bits
# Keep underlying weights in FP16 for continuous gradient accumulation
